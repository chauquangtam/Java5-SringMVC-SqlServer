...
<body>
				...
				<form:form action="menu/editpb.htm" modelAttribute="departscheckedit">

				 	<label for="id">Tên phòng ban: </label>
					<form:input path="id" required="required" value="${idname}" readonly=""/>
