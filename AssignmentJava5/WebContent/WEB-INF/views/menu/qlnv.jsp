...
<title><s:message code="global.menu.qlnv" /></title>
	...
	<div class="table-responsive">
		...
		<form action="menu/search.htm" method="get">
			<label for="name"><s:message
					code="home.home.qlnv.departmentname" /> </label> <input type="text"
				placeholder="<s:message code="home.home.qlnv.enter" />"
				required="required" name="nameEmployee" /> <input type="submit"
				value="<s:message code="home.home.qlnv.submit" />">
		</form>
		<br>
