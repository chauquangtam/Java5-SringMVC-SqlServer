...
#content form input[type="text"], #content form input[type="password"] {
	...
	background: #eae7e7
		url(https://cssdeck.com/uploads/media/items/8/8bcLQqF.png) no-repeat;
...
.button a {
	background: url(https://cssdeck.com/uploads/media/items/8/8bcLQqF.png) 0
		-112px no-repeat;
	color: #7E7E7E;
	font-size: 17px;
...
<body translate="no">
	...
	<div class="container">
		<section id="content">
			<form action="loginandregistration/login.htm" method="post">
				...
				<div>
					<input type="submit" value="Log in"> <a href="#">Bạn
						quên mật khẩu?</a> <a href="registration.htm">Đăng kí</a>
				</div>
			</form>
	...
	<script
		src="https://static.codepen.io/assets/editor/iframe/iframeRefreshCSS-d00a5a605474f5a5a14d7b43b6ba5eb7b3449f04226e06eb1b022c613eabc427.js"></script>
